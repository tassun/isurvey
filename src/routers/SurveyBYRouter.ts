...
import { SurveyBYHandler } from '../handlers/SurveyBYHandler';

export class SurveyBYRouter extends SurveyOperateRouter {
	public readonly progid : string = "survey_by";
	
	public override getHandler(): SurveyBYHandler {
		return new SurveyBYHandler(this.logger);
	}
