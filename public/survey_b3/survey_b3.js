...
function setupUI() {
    ...
    $('input[name="SB3_3_1"]').on('change', function() {
        if ($(this).val() == '2') {
...
function checkCaused() {
    ...
    let notnotify = $("#SB3_2_1_1").is(":checked");
    ...
    if(notsuccessed) {
        ...
        if(notnotify) {
            $("#SB3_2_4_4").attr('data-parsley-required', 'false');
        } else {
            $("#SB3_2_4_4").attr('data-parsley-required', 'true');
        }    
    }
    return false;
}
