...
function openSurveyBX(profile_id,survey_id,master_id,column_id) {
    ...
    startWaiting();
    submitWindow({url: BASE_URL+"/survey_b7/open", params: {token_key: token_key, profile_id: profile_id, survey_id: survey_id, master_id: master_id, column_id: column_id, main_id: main_id}, windowName: "_self"});
}
...
function searchSurveyBXDataTable(profile_id,survey_id,master_id,column_id) {
    ...
    startWaiting();
    $.ajax({
        url: BASE_URL+"/survey_b7/datatable",
        data: {
            ajax: true,
            token_key: token_key,
            profile_id: profile_id,
