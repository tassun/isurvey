...
function openSurveyBX(profile_id,survey_id,master_id,column_id) {
    ...
    startWaiting();
    submitWindow({url: BASE_URL+"/survey_b1/open", params: {profile_id: profile_id, survey_id: survey_id, master_id: master_id, column_id: column_id, main_id: main_id}, windowName: "_self"});
}
